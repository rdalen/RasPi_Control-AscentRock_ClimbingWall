...
**Caution! Because the software does not include a safety feature, the <ins>only</ins> safety measures to stop the ramp motor are two small mercury switches on the Control & Sensor Board that measure the position of the ControlBox.**
